#!/bin/sh
# concourse-deploy-docker-resource build-push.sh
...
echo "cp -r concourse-deploy-docker-resource/build-resource-using-bash/* dist"
cp -r concourse-deploy-docker-resource/build-resource-using-bash/* dist
echo " "
...
#echo "Now we must move our code from the current directory ./concourse-deploy-docker-resource to" 
#echo "$GOPATH/src/github.com/JeffDeCola/concourse-deploy-docker-resource"
#mkdir -p src/github.com/JeffDeCola/
#cp -R ./concourse-deploy-docker-resource src/github.com/JeffDeCola/.
#echo " "

#echo "cd src/github.com/JeffDeCola/concourse-deploy-docker-resource/concourse-deploy-docker-resource-code"
#cd src/github.com/JeffDeCola/concourse-deploy-docker-resource/concourse-deploy-docker-resource-code
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/concourse-deploy-docker-resource/build-resource-using-bash/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/concourse-deploy-docker-resource/build-resource-using-bash/build-push/Dockerfile" .
#echo " "
