#!/bin/sh
# concourse-deploy-docker-resource readme-github-pages.sh
...
echo "The goal is to git clone /concourse-deploy-docker-resource to /concourse-deploy-docker-resource-updated"
...
echo "git clone concourse-deploy-docker-resource to concourse-deploy-docker-resource-updated"
git clone concourse-deploy-docker-resource concourse-deploy-docker-resource-updated
echo " "

echo "cd concourse-deploy-docker-resource-updated"
cd concourse-deploy-docker-resource-updated
echo " "
