#!/bin/sh -e
# concourse-deploy-docker-resource push.sh
...
echo "    docker login"
echo "docker push jeffdecola/concourse-deploy-docker-resource"
docker push jeffdecola/concourse-deploy-docker-resource
echo " "
